...
switch($_GET["action"]) {
  case "add":
    if(!empty($_POST["quantity"])) {
      $productByCode = $db_handle->runQuery("SELECT * FROM Accessesoris WHERE code='" . $_GET["code"] . "'");
      $itemArray = array($productByCode[0]["code"]=>array('name'=>$productByCode[0]["name"], 'code'=>$productByCode[0]["code"], 'quantity'=>$_POST["quantity"], 'price'=>$productByCode[0]["price"], 'img_path'=>'accessesoris/'.$_POST["img_path"]));
...
<br><br><br>
  <div class="txt-heading" style="text-align:left;color:#d5d5d5;"><a href="../index2.php" style="text-decoration:none;color:#33B6CB;margin-left:120px;">Home/</a> Products/ <a href="" style="color:#33B6CB;text-decoration: none;">Accessesoris</a></div>
 ...
 <div class="container-fluid" style="width:90%;">
  <div class="row">
    <div class="col-sm-2" style="background-color:#e3e3e3;color:#428bca;">
              ...
              <ul>
                ...
                <li><a href="../women/women.php">Women's</a></li>
                <li><a href="">Accesssoris</a></li>
  ...
  ?>
    <div class="product-item" style="background:#fff;">
      <form method="post" action="accessesoris.php?action=add&code=<?php echo $product_array[$key]["code"]; ?>">
