...
$history_record=mysqli_query($conn,"select * from accessesoris where id=$get_id ");
...
mysqli_query($conn,"delete from accessesoris where id = '$get_id' ")or die(mysqli_error());
