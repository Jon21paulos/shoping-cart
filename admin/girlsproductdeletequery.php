...
$history_record=mysqli_query($conn,"select * from productgirl where id=$get_id");
...
mysqli_query($conn,"delete from productgirl where id = '$get_id' ")or die(mysqli_error($conn));
