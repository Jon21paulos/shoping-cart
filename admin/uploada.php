...
<style type="text/css">
	...
	<div class="col-md-6 well" style="margin-top:80px;background-color:#ffffff;border:360px;">
		<h3 class="text-primary" style="text-align:center;">MekelleShop.com-Upload-Product-Form</h3>
		<a href="accessesoris.php">back</a>
		<hr style="border-top:1px dotted #ccc;"/>
		<div class="col-md-2"></div>
		<div>
			<form role="form" method="POST" action="uploadera.php" enctype="multipart/form-data" ><br>

				<label>Product Type:</label>
				<input type="text"  class="form-control" name="name" style="width:50%;" required="" placeholder="eg:- shose,cloth," /><br>
				<label>Type:</label>
