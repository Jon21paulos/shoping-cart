...
<div class="txt-heading" style="height:40px;"><span style="margin-left:100px;"><a href="../index2.php" style="color:#33B6CB;text-decoration:none;">Home/</a> Product/<a href="women.php" style="color:#33B6CB;text-decoration:none;">women/</a> AddToCart</span></div>
...
<?php foreach ($_SESSION["cart_item"] as $item) { 
		// $product_info = $db_handle->runQuery("SELECT * FROM productgirl WHERE code = '" . $item["code"] . "'");
...
<a href="women.php" title="Cart" class="btn btn-primary" style="border-radius:5px;width:180px;">Continue Shopping</a>
<a href="#" class="btn btn-primary" style="border-radius:5px;width:180px;">Go To Puyment</a>
</div> 
</div>
    </div>
  </div>
